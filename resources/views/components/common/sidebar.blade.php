                        ...
                        <li class="menu nav-item">
                            <button type="button" class="nav-link group"
                                ...
                                <div class="rtl:rotate-180"
                                    :class="{ '!rotate-90': activeDropdown === 'transaction' }">
                            ...
                            <ul x-cloak x-show="activeDropdown === 'transaction'" x-collapse
                                ...
                                <li>
                                    <a href="/transactions">Pembayaran</a>
                                </li>
                                <li>
                                                ...
                                                <div class="flex items-center">
                                                    ...
                                                    <svg width="24" height="24" viewBox="0 0 24 24"
                                                        ...
                                                        <circle opacity="0.5" cx="15" cy="6" r="3"
                                                            fill="#1C274C" />
                                                        <ellipse opacity="0.5" cx="16" cy="17"
                                                            rx="5" ry="3" fill="#1C274C" />
                                                        <circle cx="9.00098" cy="6" r="4" fill="#1C274C" />
                                                        <ellipse cx="9.00098" cy="17.001" rx="7"
                                                            ry="4" fill="#1C274C" />
                                                    </svg>
